...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'sponsor_organization', 'description', self.gf('django.db.models.fields.CharField')(max_length=3000))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Organization.description'
        db.alter_column(u'sponsor_organization', 'description', self.gf('django.db.models.fields.CharField')(max_length=50))
