...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.contact_fname'
        db.add_column(u'sponsor_organization', 'contact_fname',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=100),
                      keep_default=False)

        # Adding field 'Organization.contact_lname'
        db.add_column(u'sponsor_organization', 'contact_lname',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.contact_fname'
        db.delete_column(u'sponsor_organization', 'contact_fname')

        # Deleting field 'Organization.contact_lname'
        db.delete_column(u'sponsor_organization', 'contact_lname')
