...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.expected_reach'
        db.add_column(u'events_event', 'expected_reach',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Event.expected_reach'
        db.delete_column(u'events_event', 'expected_reach')
