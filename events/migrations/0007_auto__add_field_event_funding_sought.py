...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.funding_sought'
        db.add_column(u'events_event', 'funding_sought',
                      self.gf('django.db.models.fields.CharField')(default='$500.00', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.funding_sought'
        db.delete_column(u'events_event', 'funding_sought')
    ...
    models = {
        ...
        u'events.event': {
            ...
            'funding_sought': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
