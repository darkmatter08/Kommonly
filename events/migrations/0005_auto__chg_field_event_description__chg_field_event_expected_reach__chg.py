...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.expected_reach'
        db.alter_column(u'events_event', 'expected_reach', self.gf('django.db.models.fields.CharField')(max_length=50000))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Event.description'
        db.alter_column(u'events_event', 'description', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Event.expected_reach'
        db.alter_column(u'events_event', 'expected_reach', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Event.name'
        db.alter_column(u'events_event', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
