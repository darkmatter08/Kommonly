...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.funding_sought'
        db.alter_column(u'events_event', 'funding_sought', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Event.funding_sought'
        db.alter_column(u'events_event', 'funding_sought', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        u'events.event': {
            ...
            'funding_sought': ('django.db.models.fields.DecimalField', [], {'max_digits': '8', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
